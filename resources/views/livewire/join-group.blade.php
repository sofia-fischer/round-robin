    ...
    <div class="relative">
        ...
        <div class="absolute top-16 sm:top-44 left-0 right-0 bottom-0  h-full flex flex-col items-center
            ...
            @if($step == 0)
                ...
                @elseif(Auth::user()->email || false)
                    <a href="{{ route('game.index') }}">
                        <div class="hover:text-yellow-300 text-sm mt-16 sm:mt-24">
                            Start a new Game
                        </div>
                    </a>
                @endif
    ...
    <div
        ...
        <div>
            ...
            <p class="mt-2">We are very delighted that you have shown interest in our enterprise. Data protection is of
                            a
                            particularly
                            high priority for the management of the Philodev (Sofia Fischer). The use of the Internet
                            pages of the
                            Philodev (Sofia Fischer) is possible without any indication of personal data; however, if a
                            data subject
                            wants to use special enterprise services via our website, processing of personal data could
                            become
            ...
            <p class="mt-2">The processing of personal data, such as the name, address, e-mail address, or telephone
                            number of a data
                            subject shall always be in line with the General Data Protection Regulation (GDPR), and in
                            accordance
                            with
                            the country-specific data protection regulations applicable to the Philodev (Sofia Fischer).
                            By means of
                            this data protection declaration, our enterprise would like to inform the general public of
                            the nature,
            ...
            <ul style="list-style: none">
                ...
                <li><h4 class="text-lg mt-4 font-semibold">i)      Recipient</h4>
                    <p class="mt-2">Recipient is a natural or legal person, public authority, agency or another body, to
                                    ...
                                    receive personal data in the framework of a particular inquiry in accordance with
                                    Union or
                                    Member
            ...
            <p class="mt-2">Controller for the purposes of the General Data Protection Regulation (GDPR), other data
                            protection laws
                            applicable in Member states of the European Union and other provisions related to data
                            protection is:
            ...
            <p class="mt-2">Many Internet sites and servers use cookies. Many cookies contain a so-called cookie ID. A
                            cookie ID is a
                            unique identifier of the cookie. It consists of a character string through which Internet
                            pages and
                            servers
                            can be assigned to the specific Internet browser in which the cookie was stored. This allows
                            visited
                            Internet sites and servers to differentiate the individual browser of the dats subject from
                            other
                            Internet
            ...
            <p class="mt-2">By means of a cookie, the information and offers on our website can be optimized with the
                            user in mind.
                            Cookies allow us, as previously mentioned, to recognize our website users. The purpose of
                            this
                            recognition
                            is to make it easier for users to utilize our website. The website user that uses cookies,
                            e.g. does not
                            have to enter access data each time the website is accessed, because this is taken over by
                            the website,
            ...
            <p class="mt-2">The data subject may, at any time, prevent the setting of cookies through our website by
                            ...
                            setting of
                            cookies.
                            Furthermore, already set cookies may be deleted at any time via an Internet browser or other
                            software
                            programs. This is possible in all popular Internet browsers. If the data subject deactivates
                            the setting
                            of cookies in the Internet browser used, not all functions of our website may be entirely
                            usable.</p>
            ...
            <div class="my-2 text-purple-600">
                ...
                I need to make sure that not a different Computer with the same cookie is using your account. This Data
                will
                be stored on my server and will only be send to <a href="https://rollbar.com/" class="text-blue-500">Rollbar</a>,
                which I use to handle Errors. This helps me to improve Round Robin but you can stop this by activating
                the
                'Do not Track' option in your Browser.
            </div>
            <div class="my-2 text-purple-600">
                The second Third Party Application I use is
                <a href="https://pusher.com/" class="text-blue-500">Pusher</a>.
                Pusher offers a Websocket Service, which I use to communicate Game States during the Game. If one player
                performs an action the information is send to all other players to update their view. You can limit
                this,
            ...
            <p class="mt-2">The website of the Philodev (Sofia Fischer) collects a series of general data and
                            ...
                            stored in the
                            server
                            log files. Collected may be (1) the browser types and versions used, (2) the operating
                            system used by
                            the
                            accessing system, (3) the website from which an accessing system reaches our website
                            (so-called
                            referrers),
                            (4) the sub-websites, (5) the date and time of access to the Internet site, (6) an Internet
                            protocol
                            address
                            (IP address), (7) the Internet service provider of the accessing system, and (8) any other
                            similar data
            ...
            <p class="mt-2">The data subject has the possibility to register on the website of the controller with the
                            indication of
                            personal data. Which personal data are transmitted to the controller is determined by the
                            respective
                            input
                            mask used for the registration. The personal data entered by the data subject are collected
                            and stored
                            exclusively for internal use by the controller, and for his own purposes. The controller may
                            request
                            transfer to one or more processors (e.g. a parcel service) that also uses personal data for
                            an internal
            ...
            <p class="mt-2">By registering on the website of the controller, the IP address—assigned by the Internet
                            service provider
                            (ISP) and used by the data subject—date, and time of the registration are also stored. The
                            storage of
                            this
                            data takes place against the background that this is the only way to prevent the misuse of
                            our services,
                            and, if necessary, to make it possible to investigate committed offenses. Insofar, the
                            storage of this
                            data
                            is necessary to secure the controller. This data is not passed on to third parties unless
                            there is a
                            statutory obligation to pass on the data, or if the transfer serves the aim of criminal
                            prosecution.
            </p>
            ...
            <p class="mt-2">The registration of the data subject, with the voluntary indication of personal data, is
                            intended to
                            enable
                            the controller to offer the data subject contents or services that may only be offered to
                            registered
                            users
                            due to the nature of the matter in question. Registered persons are free to change the
                            personal data
                            specified during the registration at any time, or to have them completely deleted from the
                            data stock of
                            the
                            controller.</p>
            ...
            <p class="mt-2">The data controller shall, at any time, provide information upon request to each data
                            subject as to what
                            personal data are stored about the data subject. In addition, the data controller shall
                            correct or erase
                            personal data at the request or indication of the data subject, insofar as there are no
                            statutory
                            storage
                            obligations. The entirety of the controller’s employees are available to the data subject in
                            this
                            respect as
                            contact persons.</p>
            ...
            <p class="mt-2">The Philodev (Sofia Fischer) offers users the possibility to leave individual comments on
                            ...
                            publicly-accessible portal, through which one or more people called bloggers or web-bloggers
                            may post
                            articles or write down thoughts in so-called blogposts. Blogposts may usually be commented
                            by third
                            parties.</p>

            <p class="mt-2">If a data subject leaves a comment on the blog published on this website, the comments made
                            by the data
                            subject are also stored and published, as well as information on the date of the commentary
                            and on the
                            user's (pseudonym) chosen by the data subject. In addition, the IP address assigned by the
                            Internet
                            service
                            provider (ISP) to the data subject is also logged. This storage of the IP address takes
                            place for
                            security
                            reasons, and in case the data subject violates the rights of third parties, or posts illegal
                            content
                            through
                            a given comment. The storage of these personal data is, therefore, in the own interest of
                            the data
                            controller, so that he can exculpate in the event of an infringement. This collected
                            personal data will
                            not
                            be passed to third parties, unless such a transfer is required by law or serves the aim of
                            the defense
                            of
            ...
            <p class="mt-2">If the storage purpose is not applicable, or if a storage period prescribed by the European
                            legislator or
                            another competent legislator expires, the personal data are routinely blocked or erased in
                            accordance
                            with
            ...
            <ul style="list-style: none;">
                ...
                <li><h4 class="text-lg mt-4 font-semibold">b) Right of access</h4>
                    <p class="mt-2">Each data subject shall have the right granted by the European legislator to obtain
                                    from the
                                    controller free information about his or her personal data stored at any time and a
                                    copy of this
                    ...
                    <p class="mt-2">Furthermore, the data subject shall have a right to obtain information as to whether
                                    personal
                                    data
                                    are transferred to a third country or to an international organisation. Where this
                                    is the case,
                                    the
                ...
                <li>
                    ...
                    <p class="mt-2">If one of the aforementioned reasons applies, and a data subject wishes to request
                                    the erasure of
                                    personal data stored by the Philodev (Sofia Fischer), he or she may, at any time,
                                    contact any
                                    employee of the controller. An employee of Philodev (Sofia Fischer) shall promptly
                                    ensure that
                                    the
                    ...
                    <p class="mt-2">Where the controller has made personal data public and is obliged pursuant to
                                    ...
                                    as
                                    processing is
                                    not required. An employees of the Philodev (Sofia Fischer) will arrange the
                                    necessary measures
                                    in
                                    individual cases.</p>
                </li>
                <li><h4 class="text-lg mt-4 font-semibold">e) Right of restriction of processing</h4>
                    ...
                    <p class="mt-2">If one of the aforementioned conditions is met, and a data subject wishes to request
                                    the
                                    restriction
                                    of the processing of personal data stored by the Philodev (Sofia Fischer), he or she
                                    may at any
                                    time
                                    contact any employee of the controller. The employee of the Philodev (Sofia Fischer)
                                    will
                                    arrange
                ...
                <li><h4 class="text-lg mt-4 font-semibold">f) Right to data portability</h4>
                    <p class="mt-2">Each data subject shall have the right granted by the European legislator, to
                                    ...
                                    point (a) of
                                    Article 9(2) of the GDPR, or on a contract pursuant to point (b) of Article 6(1) of
                                    the GDPR,
                                    and
                ...
                <li>
                    ...
                    <p class="mt-2">Each data subject shall have the right granted by the European legislator to object,
                                    ...
                                    data
                                    concerning
                                    him or her, which is based on point (e) or (f) of Article 6(1) of the GDPR. This
                                    also applies to
                    ...
                    <p class="mt-2">If the Philodev (Sofia Fischer) processes personal data for direct marketing
                                    ...
                                    concerning him
                                    or
                                    her for such marketing. This applies to profiling to the extent that it is related
                                    to such
                                    direct
                                    marketing. If the data subject objects to the Philodev (Sofia Fischer) to the
                                    processing for
                                    direct
                                    marketing purposes, the Philodev (Sofia Fischer) will no longer process the personal
                                    data for
                                    these
                                    purposes.</p>
                    ...
                    <p class="mt-2">In addition, the data subject has the right, on grounds relating to his or her
                                    particular
                                    situation,
                                    to object to processing of personal data concerning him or her by the Philodev
                                    (Sofia Fischer)
                                    for
                                    scientific or historical research purposes, or for statistical purposes pursuant to
                                    Article
                                    89(1) of
                                    the GDPR, unless the processing is necessary for the performance of a task carried
                                    out for
                                    reasons
                    ...
                    <p class="mt-2">In order to exercise the right to object, the data subject may contact any employee
                                    of the
                                    Philodev
                                    (Sofia Fischer). In addition, the data subject is free in the context of the use of
                                    information
                ...
                <li><h4 class="text-lg mt-4 font-semibold">h) Automated individual decision-making, including
                    ...
                    <p class="mt-2">Each data subject shall have the right granted by the European legislator not to be
                                    ...
                                    decision
                                    (1) is
                                    not is necessary for entering into, or the performance of, a contract between the
                                    data subject
                                    and a
                                    data controller, or (2) is not authorised by Union or Member State law to which the
                                    controller
                                    is
                    ...
                    <p class="mt-2">If the decision (1) is necessary for entering into, or the performance of, a
                                    ...
                                    explicit consent,
                                    the
                                    Philodev (Sofia Fischer) shall implement suitable measures to safeguard the data
                                    subject's
                                    rights
            ...
            <p class="mt-2">Art. 6(1) lit. a GDPR serves as the legal basis for processing operations for which we
                            obtain consent for
                            a
                            specific processing purpose. If the processing of personal data is necessary for the
                            performance of a
                            contract to which the data subject is party, as is the case, for example, when processing
                            operations are
                            necessary for the supply of goods or to provide any other service, the processing is based
                            on Article
                            6(1)
                            lit. b GDPR. The same applies to such processing operations which are necessary for carrying
                            out
                            ...
                            injured in
                            our
                            company and his name, age, health insurance data or other vital information would have to be
                            passed on
                            to a
                            doctor, hospital or other third party. Then the processing would be based on Art. 6(1) lit.
                            d GDPR.
                            ...
                            the data
                            subject
                            which require protection of personal data. Such processing operations are particularly
                            permissible
                            because
            ...
            <p class="mt-2">Where the processing of personal data is based on Article 6(1) lit. f GDPR our legitimate
                            interest is to
                            carry out our business in favor of the well-being of all our employees and the
                            shareholders.</p>
            ...
            <p class="mt-2">The criteria used to determine the period of storage of personal data is the respective
                            statutory
                            retention
                            period. After expiration of that period, the corresponding data is routinely deleted, as
                            long as it is
                            no
            ...
            <h4 class="text-lg mt-4 font-semibold">12. Provision of personal data as statutory or contractual
                                                   ...
                                                   a contract; Obligation of the data subject to provide the personal
                                                   data; possible consequences of
                                                   failure to
            ...
            <p class="mt-2">This Privacy Policy has been generated by the Privacy Policy Generator of the <a
                    href="https://dg-datenschutz.de/services/external-data-protection-officer/?lang=en">DGD - Your
                                                                                                        External
                                                                                                        DPO</a> that was
                            developed in cooperation with <a href="https://www.wbs-law.de/eng/">German
                                                                                                Lawyers</a>
