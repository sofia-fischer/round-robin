<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="text-white top-32 w-full left-0 right-0 mx-auto p-4 text-center text-xs">
                <div>
                    <h4 class="text-lg mt-4 font-semibold">Privacy Policy</h4>

                    <div class="my-2 text-purple-600">
                        Philodev here. Firstly, you are doing a good job on protecting your data and reading through
                        this. Purple text will guide on your journey through this Privacy Policy and tell what info is
                        not copy pasted legal information.
                    </div>

                    <p class="mt-2">
                        We are very delighted that you have shown interest in our enterprise. Data protection is of a
                        particularly high priority for the management of the Philodev (Sofia Fischer). The use of the
                        Internet pages of the Philodev (Sofia Fischer) is possible without any indication of personal
                        ...
                        necessary and there is no statutory basis for such processing, we generally obtain consent from
                        the data subject.
                    </p>
                    ...
                    <p class="mt-2">
                        ...
                        and in accordance with the country-specific data protection regulations applicable to the
                        Philodev (Sofia Fischer). By means of this data protection declaration, our enterprise would
                    ...
                    <p class="mt-2">
                        As the controller, the Philodev (Sofia Fischer) has implemented numerous technical and
                        ...
                        gaps, so absolute protection may not be guaranteed.
                    </p>

                    <h4 class="text-lg mt-4 font-semibold">1. Definitions</h4>
                    <p class="mt-2">
                        The data protection declaration of the Philodev (Sofia Fischer) is based on the
                    ...
                    <p class="mt-2">
                        Email: sofia.k.christ@gmail.com</p>
                    <p class="mt-2">Website: www.round-robin.philodev.one</p>

                    <h4 class="text-lg mt-4 font-semibold">3. Cookies</h4>
                    <p class="mt-2">
                        The Internet pages of the Philodev (Sofia Fischer) use cookies. Cookies are text files that are
                        stored in a computer system via an Internet browser.
                    </p>

                    <div class="my-2 text-purple-600">
                        There is one cookie stored while you are here. It handles automatic login (if you are not
                        staying away for too long). This also works if you don't want to enter an email address. If you
                        delete the cookie or don't accept it in the first place, nothing bad will happen, but you will
                        have to login every time you visit the Round Robin.
                    </div>
                    ...
                    <p class="mt-2">
                        Through the use of cookies, the Philodev (Sofia Fischer) can provide the users of this website
                    ...
                    <div class="my-2 text-purple-600">
                        ...
                        Pusher offers a Websocket Service, which I use to communicate Game States during the Game. If
                        one player performs an action the information is send to all other players to update their view.
                        You can limit this, but be prepared to reload that page often to play.
                    </div>

                    <p class="mt-2">
                        The website of the Philodev (Sofia Fischer) collects a series of general data and information
                    ...
                    <p class="mt-2">
                        When using these general data and information, the Philodev (Sofia Fischer) does not draw any
                        ...
                        for criminal prosecution in case of a cyber-attack. Therefore, the Philodev (Sofia Fischer)
                    ...
                    <div class="my-2 text-purple-600">
                        ...
                        Currently I don't use the email address for anything but identification, but I might send a
                        little info about a new game or so in the future.
                    </div>
                    ...
                    <p class="mt-2">
                        ...
                        the misuse of our servies, and, if necessary, to make it possible to investigate committed
                    ...
                    <p class="mt-2">
                        The Philodev (Sofia Fischer) offers users the possibility to leave individual comments on
                        individual blog contributions on a blog, which is on the website of the controller. A blog is a
                        web-based, publicly-accessible portal, through which one or more people called bloggers or
                        web-bloggers may post articles or write down thoughts in so-called blogposts. Blogposts may
                    ...
                    <p class="mt-2">
                        ...
                        commentary and on the user's (pseudonym) chosen by the data subject. In addition, the IP address
                        assigned by the Internet service provider (ISP) to the data subject is also logged. This storage
                        of the IP address takes place for security reasons, and in case the data subject violates the
                        rights of third parties, or posts illegal content through a given comment. The storage of these
                        personal data is, therefore, in the own interest of the data controller, so that he can
                        exculpate in the event of an infringement. This collected personal data will not be passed to
                        third parties, unless such a transfer is required by law or serves the aim of the defense of the
                        data controller.
                    </p>
                    ...
                    <div class="my-2 text-purple-600">
                        If you don't have an email address set, I will delete your account after one month. If you have,
                        I will delete your account after 6 Month of not logging in. There is the possibility to delete
                        your account yourself in the profile settings (upper right corner - only if you have an email
                        address set).
                    </div>
                    ...
                    <ul style="list-style: none;">
                        ...
                        <li>
                            ...
                            <p class="mt-2">
                                ...
                                erasure of personal data stored by the Philodev (Sofia Fischer), he or she may, at any
                                time, contact any employee of the controller. An employee of Philodev (Sofia Fischer)
                            ...
                            <p class="mt-2">
                                ...
                                those personal data, as far as processing is not required. An employees of the Philodev
                                (Sofia Fischer) will arrange the necessary measures in individual cases.
                            </p>
                        </li>
                        <li><h4 class="text-lg mt-4 font-semibold">e) Right of restriction of processing</h4>
                            ...
                            <p class="mt-2">
                                ...
                                restriction of the processing of personal data stored by the Philodev (Sofia Fischer),
                                he or she may at any time contact any employee of the controller. The employee of the
                                Philodev (Sofia Fischer) will arrange the restriction of the processing.
                            </p>
                        </li>
                        <li><h4 class="text-lg mt-4 font-semibold">f) Right to data portability</h4>
                            ...
                            <p class="mt-2">
                                ...
                                any time contact any employee of the Philodev (Sofia Fischer).
                            </p>
                        </li>
                        <li>
                            ...
                            <p class="mt-2">
                                The Philodev (Sofia Fischer) shall no longer process the personal data in the event of
                            ...
                            <p class="mt-2">
                                If the Philodev (Sofia Fischer) processes personal data for direct marketing purposes,
                                the data subject shall have the right to object at any time to processing of personal
                                data concerning him or her for such marketing. This applies to profiling to the extent
                                that it is related to such direct marketing. If the data subject objects to the Philodev
                                (Sofia Fischer) to the processing for direct marketing purposes, the Philodev (Sofia
                                Fischer) will no longer process the personal data for these purposes.
                            </p>
                            ...
                            <p class="mt-2">
                                ...
                                the Philodev (Sofia Fischer) for scientific or historical research purposes, or for
                            ...
                            <p class="mt-2">
                                ...
                                the Philodev (Sofia Fischer). In addition, the data subject is free in the context of
                        ...
                        <li><h4 class="text-lg mt-4 font-semibold">
                            ...
                            <p class="mt-2">
                                ...
                                explicit consent, the Philodev (Sofia Fischer) shall implement suitable measures to
                            ...
                            <p class="mt-2">
                                ...
                                decision-making, he or she may, at any time, contact any employee of the Philodev (Sofia
                                Fischer).
                            </p>
                        ...
                        <li><h4 class="text-lg mt-4 font-semibold">i) Right to withdraw data protection consent </h4>
                            ...
                            <p class="mt-2">
                                ...
                                at any time, contact any employee of the Philodev (Sofia Fischer).
                            </p>
                    ...
                    <h4 class="text-lg mt-4 font-semibold">
                        12. Provision of personal data as statutory or contractual requirement; Requirement necessary to
                    ...
                    <p class="mt-2">As a responsible company, we do not use automatic decision-making or profiling.
                    </p>
