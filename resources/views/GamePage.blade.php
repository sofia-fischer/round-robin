...
<x-app-layout>
    <div class="max-w-7xl mx-auto mt-4 sm:px-6 lg:px-8 flex">
        ...
        <div class="w-full">
            ...
            <div class="text-center text-lg text-purple-600 font-semibold flex items-center justify-center bg-white">
                <div>{{ $game::$title }}</div>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-b-xl sm:p-4">
